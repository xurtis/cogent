...
fun goal_get_intros @{term_pat "ttyping _ _ _ _ _"}         = SOME @{thms ttyping_ttyping_all.intros}
| goal_get_intros @{term_pat "ttyping_all _ _ _ _ _"}       = SOME @{thms ttyping_ttyping_all.intros}
